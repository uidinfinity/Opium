package we.devs.opium.client.auth.microsoft;
...
import we.devs.opium.client.utils.network.Http;
...
public class MicrosoftLogin {
    ...
    private static void startServer() {
        ...
        try {
            ...
            server.setExecutor(ThreadManager.executor);
            server.start();
        } catch (IOException e) {
